<template>
  <div class="home py-5 px-20 max-sm:px-8">
    ...
    <!-- info-->
    <div class="rounded-lg bg-[#f4f6fe] h-full sm:h-20 py-4 mt-5 mb-5 flex items-center justify-around w-2/5 max-sm:w-full m-auto shadow-[inset_0rem_0.2rem_0.4rem_0_rgb(0,0,0,0.1)]">
